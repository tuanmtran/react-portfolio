            ...
            <div id="Ongoing" class="box-border pb-48 w-sceen overflow-x-hidden">
                ...
                <ol class="relative border-l top-10 border-gray-200 dark:border-gray-700 pr-16 md:pr-32">                  
                    <li class="mb-10 ml-6">            
                        ...
                        <p class="mb-4 pl-5text-base font-normal text-gray-500 dark:text-gray-400 flex-auto">Computer Vision program that track wrist postures, detecting potential risks in developing Carpal Tunnel Syndrome.</p>
                    ...
                    <li class="mb-10 ml-6">
                        ...
                        <p class="text-base font-normal text-gray-500 dark:text-gray-400">An AI-Powered tool that improves an individual ability to converse, allowing for a personal learning experience that encourage growth in communication</p>
                    </li>
                </ol>
